...
class TestNeuronClass(unittest.TestCase):
    ...
    def test_seed_init_1(self):
        self.assertEqual(self.test.seed, 20180121)
    ...
    def test_thresh_type_init_1(self):
        self.assertEqual(self.test.thresh_type, 'linear')
    ...
    def test_thresholdH(self):
        ...
        test2 = pcn.neuron(2, thresh_type = "logistic")
        self.assertEqual(test2.thresholdH(0.9), 1)
        self.assertEqual(test2.thresholdH(-0.3), 0)
